...
axis('off');%覆盖坐标刻度，并填充背景?%通过填充绘出台阶及两边的挡板? 
...
%body=line(-5,1,'color','b','linestyle','-','erasemode','none');?%描绘轨迹线?%设置初始条件
...
while t<=4.12
    ...
    y=(-w*w)+1;
    set(head,'xdata',t,'ydata',y);%设置球的运动?%set(body,'xdata',t,'ydata',y);%描绘轨迹线
    drawnow;
end
